...
export default async function AccountPage() {
  ...
  return (
    <>
      {/* Phones get the app's profile screen; the wide layout below is for desktop. */}
      <div className="lg:hidden">
        <MobileProfile
          name={profile?.full_name?.trim() || (meta.full_name as string) || (meta.name as string) || ''}
          email={user.email ?? ''}
          avatar={avatar}
          stats={stats}
          account={account?.display ?? null}
        />
      </div>
